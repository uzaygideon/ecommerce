...
<Divider  />
    ...
    <a href=""> <ShoppingCartIcon style={{color:'rgb(164,102,68)'}}/>Add To Cart</a>
    ...
    >
      ...
      <Link to="">About</Link>
      <Divider orientation="vertical" variant="middle"  flexItem sx={{border:'1px solid rgba(228, 226, 226,0.5)'}}/>
      <Link to="commerceapp">Shops</Link>
      <Divider orientation="vertical" variant="middle"  flexItem sx={{border:'1px solid rgba(228, 226, 226,0.5)'}}/>
      <Link to="">News</Link>
      <Divider orientation="vertical" variant="middle"  flexItem sx={{border:'1px solid rgba(228, 226, 226,0.5)'}}/>
    ...
    <div className='cent-text'>Styles <span className='spec-2'>and</span> Trends</div>
    <div className="app-con">
    <button class="button-2"> <span>Book an Appointment </span></button>
    </div>
    </div>
  </>
  )
