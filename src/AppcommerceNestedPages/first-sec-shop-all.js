...
import '../HomePageFolder/FirstHomeSec.css'
...
function ShopForAll({totalItems}) {
...
<Divider  />
    ...
    >
      ...
      <Link to="">About</Link>
      <Divider orientation="vertical" variant="middle"  flexItem sx={{border:'1px solid rgba(228, 226, 226,0.5)'}}/>
      <Link to="commerceapp" style={{color:'rgb(164,102,68)'}}>Suits</Link>
      <Divider orientation="vertical" variant="middle"  flexItem sx={{border:'1px solid rgba(228, 226, 226,0.5)'}}/>
      <Link to="">News</Link>
      <Divider orientation="vertical" variant="middle"  flexItem sx={{border:'1px solid rgba(228, 226, 226,0.5)'}}/>
    ...
    <div className='cent-text'><span className='spec-2'>CARTS</span></div>
